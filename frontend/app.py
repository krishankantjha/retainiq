...
<style>
    ...
    /* Sidebar Navigation Button Restyling (Basic spacing and colors for Phase 1) */
    ...
    .health-banner {{
        ...
        /* Dynamic active button styles inside the native stSidebar (Basic highlighting for Phase 1) */
